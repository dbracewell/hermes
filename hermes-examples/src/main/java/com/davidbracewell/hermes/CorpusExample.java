...
public class CorpusExample {
   ...
   public static void main(String[] args) throws Exception {
      ...
      Corpus corpus = Corpus.builder()
                            ...
                            //format is assumed.)
                            .source(CorpusFormats.PLAIN_TEXT_OPL,
                                    Resources.fromClasspath("com/davidbracewell/hermes/example_docs.txt"))
      ...
      System.out.println(
         corpus.query("younger AND (brother OR sister)").size() + " documents match (younger AND (brother OR sister))");
      System.out.println();
      ...
      LDAModel model = lda.train(corpus.asClassificationDataSet(BagOfAnnotations.builder()
                                                                                .ignoreStopWords()
                                                                                .lowerCase()
                                                                                .build()));
